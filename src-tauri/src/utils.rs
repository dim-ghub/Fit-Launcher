...
#[tauri::command]
#[specta]
pub fn get_install_queue_status() -> Result<fit_launcher_ui_automation::QueueStatus, CustomError> {
    fit_launcher_ui_automation::get_install_queue_status().map_err(|e| CustomError { message: e })
}
